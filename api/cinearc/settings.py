"""
Django settings for cinearc project.
...
# Import des paramètres de Celery lors du démarrage
...
CELERY_BROKER_URL = 'redis://redis:6379/0'  # Nom du service Redis dans docker-compose
